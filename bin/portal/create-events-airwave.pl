...
our $EVENT_DIR = "$ENV{'AIRWAVE_ROOT'}/../$CONFIG{PORTAL_STATS}/Airwave/$CCYY/$YYMM";
...
#			$price[1] = (150,175,195,200,225,245,250,275,299,300,325,350,375,400,425,450,475,499,500,525,550,575,599,600,625)[$index];
			$index = int(rand(20));
			$price[0] = (325,350,375,395,400,425,450,475,495,500,525,550,575,600,660,699,700,750,799,850)[$index];
			$price[1] = (150,175,195,200,225,245,250,275,299,300,325,350,375,400,425,450,475,499,500,550)[$index];
